...
public class ReviewDto {
    ...
    public ReviewDto(long reviewId, long roomId, long mentorId, long menteeId, String reviewTitle, String reviewContent, String reviewCodePath, Date reviewRegDate, int reviewLanguage) {
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof ReviewDto)) {
            return false;
        } else {
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ReviewDto;
    }
    ...
    public String toString() {
        return "ReviewDto(reviewId=" + this.getReviewId() + ", roomId=" + this.getRoomId() + ", mentorId=" + this.getMentorId() + ", menteeId=" + this.getMenteeId() + ", reviewTitle=" + this.getReviewTitle() + ", reviewContent=" + this.getReviewContent() + ", reviewCodePath=" + this.getReviewCodePath() + ", reviewRegDate=" + this.getReviewRegDate() + ", reviewLanguage=" + this.getReviewLanguage() + ", reviewCode=" + this.getReviewCode() + ")";
    }

    public ReviewDto(final long reviewId, final long roomId, final long mentorId, final long menteeId, final String reviewTitle, final String reviewContent, final String reviewCodePath, final Date reviewRegDate, final int reviewLanguage, final String reviewCode) {
        this.reviewId = reviewId;
        this.roomId = roomId;
        this.mentorId = mentorId;
        this.menteeId = menteeId;
