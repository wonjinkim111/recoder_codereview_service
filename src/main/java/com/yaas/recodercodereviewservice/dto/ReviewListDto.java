...
public class ReviewListDto {
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof ReviewListDto)) {
            return false;
        } else {
            ReviewListDto other = (ReviewListDto)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ReviewListDto;
    }
    ...
    public String toString() {
        return "ReviewListDto(reviewId=" + this.getReviewId() + ", roomId=" + this.getRoomId() + ", mentorId=" + this.getMentorId() + ", menteeId=" + this.getMenteeId() + ", reviewTitle=" + this.getReviewTitle() + ", reviewRegDate=" + this.getReviewRegDate() + ", reviewLanguage=" + this.getReviewLanguage() + ", reviewCodePath=" + this.getReviewCodePath() + ", menteeNickname=" + this.getMenteeNickname() + ")";
    }

    public ReviewListDto(final long reviewId, final long roomId, final long mentorId, final long menteeId, final String reviewTitle, final Date reviewRegDate, final int reviewLanguage, final String reviewCodePath, final String menteeNickname) {
        this.reviewId = reviewId;
        this.roomId = roomId;
        this.mentorId = mentorId;
        this.menteeId = menteeId;
