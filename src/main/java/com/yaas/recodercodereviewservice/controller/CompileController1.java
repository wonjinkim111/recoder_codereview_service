...
public class CompileController1 {
    private static final Logger log = LoggerFactory.getLogger(CompileController1.class);
    ...
    @Autowired
    public CompileController1(ICompileService iCompileService, CompileProcess compileProcess, CompileProcess2 compileProcess2, CompileProcess3 compileProcess3) {
    ...
    public String getResultWindow(@RequestParam long reviewId) {
        ...
        String result = CompileProcess3.execute(compileDto.getReviewCodePath());
        System.out.println("컨트롤러 와서 출력하기 >>>>");
        System.out.println(result);
        return result;
    }
